...
func FieldFiltersBuild() FieldFilterOutputJSON {
    var items []FieldFilter
    var item FieldFilter
    var options []FieldFilterDropdownOption
    var option FieldFilterDropdownOption
    var name_id string
    var option_text string
    var option_value string
    var output FieldFilterOutputJSON
